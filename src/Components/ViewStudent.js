                                ...
                                <tr key={ind}>
                                  ...
                                  <td>
                                    <div className='flex flex-col'>
                                      <img src={val.image ? `${api}/Images/${val.image}` : errorImage} className='w-[60px] h-[70px] md:w-[80px] md:h-[100px] mr-2' alt={`${val.studentname}`} />
                            ...
                            allStudentData.map((val, ind) => {
                              return (
                                <tr key={ind}>
                                  ...
                                  <td>
                                    <div className='flex flex-col'>
                                      <img src={val.image ? `${api}/Images/${val.image}` : errorImage} className='w-[60px] h-[70px] mr-2' alt={`${val.studentname}`} />
                                      <div className={`flex justify-start mt-2`}>
                                        <i className={`fa-solid fa-pen mr-2 cursor-pointer`} onClick={() => modelImage(val._id)}></i>
                                        <i className={`fa-solid fa-trash cursor-pointer text-red-500 ${val.image ? "block" : "hidden"}`} onClick={() => deleteImage(val._id)}></i>
                                      </div>
